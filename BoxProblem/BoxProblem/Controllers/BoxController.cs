...
namespace BoxProblem.Controllers
{
    public class BoxController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Search(int? weight, int? volume, bool? canHoldLiquid, double? cost, int? inventoryCount)
        {
            return View("Index", service.Search(weight, volume, canHoldLiquid, cost, inventoryCount));
        }
